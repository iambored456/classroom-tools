...
function queryElements(): DOMCache {
    return {
        ...
        wakeLockToggleInput: document.getElementById("wake-lock-toggle"),
        wakeLockStatusEl: document.getElementById("wake-lock-status"),
        wakeLockMessageEl: document.getElementById("wake-lock-message"),
